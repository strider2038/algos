package bitmap_ordered_search_test
...
import (
	...
	"github.com/strider2038/algos/search_in_trees/bitmap_ordered_search"
...
func loadTree(tb testing.TB) *bitmap_ordered_search.Tree {
	_, filename, _, _ := runtime.Caller(0)
	tree, err := bitmap_ordered_search.LoadFromFile(filepath.Dir(filename) + "/../../testdata/classifiers/okved.csv")
	if err != nil {
