package sparsebits_search_test
...
import (
	...
	"github.com/strider2038/algos/search_in_trees/sparsebits_search"
...
func loadTree(tb testing.TB) *sparsebits_search.Tree {
	_, filename, _, _ := runtime.Caller(0)
	tree, err := sparsebits_search.LoadFromFile(filepath.Dir(filename) + "/../../testdata/classifiers/okved.csv")
	if err != nil {
